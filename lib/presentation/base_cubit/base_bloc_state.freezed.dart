...
mixin _$BaseBlocState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is BaseBlocState<T>);
  }
...
class $BaseBlocStateCopyWith<T, $Res> {
  $BaseBlocStateCopyWith(
      BaseBlocState<T> _, $Res Function(BaseBlocState<T>) __);
}
...
class _Next<T> implements BaseBlocState<T> {
  ...
  _$NextCopyWith<T, _Next<T>> get copyWith =>
      __$NextCopyWithImpl<T, _Next<T>>(this, _$identity);
...
/// @nodoc
abstract mixin class _$NextCopyWith<T, $Res>
    implements $BaseBlocStateCopyWith<T, $Res> {
  factory _$NextCopyWith(_Next<T> value, $Res Function(_Next<T>) _then) =
      __$NextCopyWithImpl;
  @useResult
  $Res call({T data});
}
...
/// @nodoc
class __$NextCopyWithImpl<T, $Res> implements _$NextCopyWith<T, $Res> {
